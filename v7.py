...
class RegistroDeDatos:
	...
	def BitPacking(self):
		...
		if (genero == "M"):
			datos = datos | 8 # (1000 es igual a 8 en binario)
		elif (genero == "F"):
			datos = datos | 7 # (0111 es igual a 7 en binario)

		estado = input("Cual es su estado civil? (S/C)\n")

		if (genero == "S"):
			datos = datos | 5 # (0101 es igual a 5 en binario)
		elif (estado == "C"):
			datos = datos | 4 # (0100 es igual a 4 en binario)

		grado = input("Cual es su grado academico? (I/M/G/P)\n")

		if (grado == "I"):
			datos = datos | 0 # (0000 es igual a 0 en binario)
		elif (grado == "M"):
			datos = datos | 1 # (0001 es igual a 1 en binario)
		elif (grado == "G"):
			datos = datos | 2 # (0010 es igual a 2 en binario)
		elif (grado == "P"):
			datos = datos | 3 # (0011 es igual a 3 en binario)

			return datos

	def Identidad(object obj):
